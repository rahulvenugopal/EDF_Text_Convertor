...
%%%%%%%% Correction Start %%%% by Dr Arun Sasidharan 22-04-2018 %%%%%%%%
if header.duration == 0
    header.duration = 1;% This may happen for annotations generated by POLYMAN
end
%%%%%%%% Correction End %%%% by Dr Arun Sasidharan 22-04-2018 %%%%%%%%


%%%%%%%% Correction Start %%%% by Dr Arun Sasidharan 02-05-2018 %%%%%%%%
%Rs=cumsum([1; header.duration*header.samplerate]); % ñòðîêà èíäåêñîâ ïîäáëîêîâ êàíàëîâ Rs(k):Rs(k+1)-1

Rs=cumsum([1; header.samplerate]);% Removed header.duration as it wrongly computes block size when~=1
% separating of signals of everyone the channel from blocks 
% and recording of signals in structure of cells
%%%%%%%% Correction End %%%% by Dr Arun Sasidharan 02-05-2018 %%%%%%%%
